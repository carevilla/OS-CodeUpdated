...
//Add the following struct definitions to kernel/proc.h just before the struct proc definition:
...
struct proc {
  ...
  //Add the following field definitions to struct proc in kernel/proc.h (p->lock not required):
